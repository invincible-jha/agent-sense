"""Plugin registry for agent-sense.
...
class PluginRegistry(Generic[T]):
    ...
    def load_entrypoints(self, group: str) -> None:
        ...
        ----------
        group:
            The entry-point group name, e.g. "agent_sense.plugins".
        ...
        Then at runtime::
            ...
            registry.load_entrypoints("agent_sense.plugins")
        """
